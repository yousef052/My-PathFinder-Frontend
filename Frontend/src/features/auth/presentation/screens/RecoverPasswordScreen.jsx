    ...
    <>
      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
        ...
        >
          ...
          {error && (
            <div className="mb-8 rounded-2xl border border-red-100 bg-red-50 p-4 text-center text-xs font-black uppercase tracking-widest text-red-600 shadow-sm" style={{ animation: "fadeSlideUp 0.3s ease both" }}>
              ⚠️ {error}
            </div>
          )}
