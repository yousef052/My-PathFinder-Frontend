      ...
      <div className="bg-white rounded-3xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh]">
          ...
          <form id="job-form" onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 bg-slate-50 rounded-xl outline-none border border-gray-200"
                />
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-500 mb-1">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full p-2.5 bg-slate-50 rounded-xl outline-none border border-gray-200 h-24 resize-none"
              />
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full p-2.5 bg-slate-50 rounded-xl outline-none border border-gray-200 text-sm"
                />
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-500 mb-1">
        ...
        <div className="p-4 border-t border-gray-100 flex gap-3 shrink-0">
          <Button
            type="button"
            onClick={onClose}
            className="flex-1 !bg-gray-100 !text-gray-600 border"
          >
            Cancel
          </Button>
          <Button
